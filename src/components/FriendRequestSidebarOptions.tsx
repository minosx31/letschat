...
const FriendRequestSidebarOptions: FC<FriendRequestSidebarOptionsProps> = ({ sessionId, initialUnseenRequestCount }) => {
  ...
  return <Link href='/dashboard/requests' className='text-gray-800 hover:text-indigo-600 hover:bg-gray-50 group flex gap-3 rounded-md p-2 leading-6 font-semibold'>
